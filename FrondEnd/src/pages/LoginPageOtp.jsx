...
export default function LoginPageOtp() {
  ...
  const handleRequestOtp = async () => {
    ...
    try {
      const response = await requestPasswordResetOtp(resetForm.username.trim());
          ...
          >
            ...
            <div className="forgot-password-panel">
              ...
              {forgotPasswordNotice ? (
                <p className="message success-message">{forgotPasswordNotice}</p>
              ) : null}
              ...
              <div className="auth-modal-actions">
                {resetStep === RESET_STEPS.REQUEST_OTP ? (
                  <>
                    ...
                    >
                      {isResetSubmitting ? "Sending..." : "Send OTP"}
                    </button>
                  </>
                ) : null}
                ...
                {resetStep === RESET_STEPS.VERIFY_OTP ? (
                  <>
                    ...
                    >
                      {isResetSubmitting ? "Verifying..." : "Verify OTP"}
                    </button>
                  </>
                ) : null}
